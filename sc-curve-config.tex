...
implies
	...
	\end{itemize}	
		...
		%We will prove the 
		%claim as well as the construction of $\mathcal{L}_1$, $\mathcal{L}_2$, \ldots, $\mathcal{L}_{24}$ simultaneously. 
...
More precisely,  a line $l_{\alpha_i,\beta_j}$ of type $A$ is contained only  in $\mathcal{L}_{\alpha_i}$ and in $ \mathcal{L}_{\beta_j}$. 
		...
		%\[
		%\bigcup\limits_{i=1}^{4} \mathcal{L}_{\alpha_i} = \text{Set of all lines of type $A$} = \bigcup\limits_{j=1}^{4} \mathcal{L}_{\beta_j}
		%\]
